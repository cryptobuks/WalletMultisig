...
var userRoleSql = {
	...
	getRequestById: "SELECT erc20_request.amount AS ammount, user.local_blockchain_address AS address FROM erc20_request, user WHERE user.email = erc20_request.email and id = ?",
};
